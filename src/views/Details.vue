    ...
    <div class="info">
      ...
      <div class="item-style">
        <div class="operation">
          ...
          <div class="operation-item"><el-button  icon="el-icon-star-off" @click="addColletClick"></el-button> 收藏</div>
          <!-- <div class="operation-item"><i slot="suffix" class="el-icon-star-off" @click="addColletClick"></i> 收藏</div> -->
...
import { addOrderToCollect } from "../api/collect";
...
export default {
  ...
  methods: {
    ...
    addColletClick (){
      addOrderToCollect({order_id: this.data.orderId,
      })
      .then((res) => {
          console.log(res);
          if (res.flag == true) {
